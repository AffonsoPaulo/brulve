<x-main>
    <x-slot:title>Editar Endereço</x-slot:title>
    <x-slot:links>
    ...
    <section class="d-flex justify-content-between align-content-center flex-wrap bg-body-tertiary rounded-3 p-3 mt-3"
        ...
        <h5 class="m-0">Editar endereço</h5>
    ...
    <section class="bg-body-tertiary rounded-3 p-3 mt-3">
        <form action="{{ route('address.update', $address->id) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('zip') is-invalid @enderror" id="zip" name="zip"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('street') is-invalid @enderror" id="street" name="street"
                       placeholder="Rua General Osório"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('complement') is-invalid @enderror" id="complement"
                       name="complement" placeholder="Bloco A, Apt. 8" value="{{ $address->complement }}">
                @error('complement')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
